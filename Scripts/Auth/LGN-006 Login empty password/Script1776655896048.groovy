...
txtPassReq = WebUI.getText(findTestObject('Page_Swag Labs/Pass_required_text'))

print(txtPassReq)

WebUI.verifyElementText(findTestObject('Page_Swag Labs/Pass_required_text'), 'Epic sadface: Password is required')
